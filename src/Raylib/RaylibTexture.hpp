...
namespace Raylib {
     ...
     * @return Image structure containing the image
     */
     ...
     * @return True if the image is exported, False otherwise
     */
     ...
     * @return Image from another image
     */
     ...
     * @return Image created from custom font text
     */
     ...
     * @param texture Texture width
     * @return Image to get from screen
     */
